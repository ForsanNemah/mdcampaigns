...
class Register extends SimplePage
{
    ...
    public function register(): ?RegistrationResponse
    {
        ...
        $user =Account::create([
            ...
            'accountable_id'=>$this->LastAdeddRegister(),
        ]);
    ...
    {
        return       TextInput::make('user_phone')
    ...
    protected function getUserInformationFormComponent(): Component
    {
        return  TextArea ::make('user_information')
    ...
    protected function LastAdeddRegister(){
